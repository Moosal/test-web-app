                                    ...
                                    <div class="navbar">
                                        <div class="float-start me-auto">
                                            <div class="add-emp-section">
                                                <a href="#" class="btn btn-success btn-add-emp" data-bs-toggle="modal" data-bs-target="#add_holiday"><i class="fas fa-plus"></i> Add Task</a>
                                            </div>
                                        </div>
                                        <a class="task-chat profile-rightbar float-end" id="task_chat" href="{{url('#task_window')}}"><i class="fa fa fa-comment"></i></a>
                                ...
                                <div class="chat-footer">
                                    <div class="message-bar">
                                        <div class="message-inner">
                                            <a class="link attach-icon" href="#"><img src="{{ URL::asset('/assets/img/attachment.png')}}" alt=""></a>
