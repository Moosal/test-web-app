                                    ...
                                    <div class="chat-content-wrap">
                                        ...
                                        <div class="call-users">
                                            <ul>
                                                <li>
                                                    <a href="#">
                                                        <img src="{{ URL::asset('/assets/img/profiles/avatar-03.jpg')}}" class="img-fluid" alt="">
                                                        <span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#">
                                                        <img src="{{ URL::asset('/assets/img/profiles/avatar-08.jpg')}}" class="img-fluid" alt="">
                                                        <span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#">
                                                        <img src="{{ URL::asset('/assets/img/profiles/avatar-05.jpg')}}" class="img-fluid" alt="">
                                                        <span class="call-mute"><i class="fa fa-microphone-slash"></i></span>
                                                    </a>
                                                </li>
                                            </ul>
                                                    ...
                                                    <div class="chat chat-left">
                                                        <div class="chat-avatar">
                                                            <a href="{{url('profile')}}" class="avatar">
                                                                <img alt="John Doe" src="{{ URL::asset('/assets/img/profiles/avatar-02.jpg')}}">
                                                            </a>
                                                        </div>
                                                        <div class="chat-body">
