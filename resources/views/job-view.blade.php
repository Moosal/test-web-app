                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="job-det-info job-widget">
                                <a class="btn job-btn" href="#" data-bs-toggle="modal" data-bs-target="#apply_job">Apply For This Job</a>
                                <div class="info-list">
                                ...
                                <div class="info-list">
                                    ...
                                    <br> <a href="{{url('mailto:danielporter@example.com')}}" title="danielporter@example.com">danielporter@example.com</a>
                                    <br> <a href="{{url('https://www.example.com')}}" target="_blank" title="https://www.example.com">https://www.example.com</a>
                                    </p>
                                </div>
