                            ...
                            <div class="activity">
                                <div class="activity-box">
                                    <ul class="activity-list">
                                        ...
                                        <li>
                                            <div class="activity-user">
                                                <a href="{{url('profile')}}" class="avatar" title="Jeffery Lalor" data-bs-toggle="tooltip">
                                                    <img src="{{ URL::asset('/assets/img/profiles/avatar-16.jpg')}}" alt="">
                                                </a>
                                            </div>
                                            <div class="activity-content">
                                                <div class="timeline-content">
                                                    <a href="{{url('profile')}}" class="name">Jeffery Lalor</a> added <a href="{{url('profile')}}" class="name">Loren Gatlin</a> and <a href="{{url('profile')}}" class="name">Tarah Shropshire</a> to project <a href="#">Patient appointment booking</a>
                                        ...
                                        <li>
                                            ...
                                            <div class="activity-content">
                                                <div class="timeline-content">
                                                    <a href="{{url('profile')}}" class="name">Jeffery Lalor</a> added <a href="{{url('profile')}}" class="name">Jeffrey Warden</a> and <a href="{{url('profile')}}" class="name">Bernardo Galaviz</a> to the task of <a href="#">Private chat module</a>
