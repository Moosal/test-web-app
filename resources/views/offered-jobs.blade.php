...
@component('components.breadcrumb')                
    @slot('title') Offered Jobs @endslot
    @slot('li_1') Dashboard @endslot
    @slot('li_2') Offered Jobs @endslot
@endcomponent 
                                ...
                                <table class="table table-striped custom-table mb-0 datatable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="#" class="role-info role-bg-two download-offer"><span><i class="fa fa-download me-1"></i> Download Offer</span></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
