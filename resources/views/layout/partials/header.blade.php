...
<!-- Header -->
            <div class="header">
                ...
                <ul class="header-new-menu">
                    ...
                    <li>
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="{{url('task-board')}}">Task Board</a>
                        </div>
                    </li>
                    <li>
                        <a href="#" data-bs-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Leads</a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{url('leads')}}">Leads</a>
                        </div>
                    </li>
                    <li>
                ...
                <a id="mobile_btn" class="mobile_btn" href="{{url('#sidebar')}}"><i class="fa fa-bars"></i></a>
                ...
                <ul class="nav user-menu">
                    ...
                    <li class="nav-item dropdown has-arrow main-drop">
                        <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                            <span class="user-img"><img src="{{ URL::asset('/assets/img/profiles/avatar-21.jpg')}}" alt=""></span>
                            <span>Admin</span>
                        </a>
                        <div class="dropdown-menu">
