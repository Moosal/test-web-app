...
@component('components.breadcrumb')                
    @slot('title') Hospital Admin @endslot
    @slot('li_1') Dashboard @endslot
    @slot('li_2') Hospital Admin @endslot
@endcomponent
@component('components.search-filder') 
    @slot('li_1') View Taskboard @endslot
    @slot('li_2') Create Project @endslot
@endcomponent 
@section('css')
    <!-- Select2 CSS -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="project-title">
                                        ...
                                        <h6>3 open tasks, 3 tasks completed</h6>
                                    </div>
                                ...
                                <div class="card-body prj-tbl pb-0">
                                    ...
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Created by:</td>
                                                <td class="text-end"><a href="profile">Barry Cuda</a></td>
                                            </tr>
                                            <tr>
                                                <td>Status:</td>
