                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="profile-info-left">
                                                        ...
                                                        <div class="staff-msg"><a href="{{url('chat')}}" class="btn btn-custom">Send Message</a></div>
                                                    </div>
                                                </div>
                                                <div class="col-md-7">
                        ...
                        <div class="row user-tabs">
                            <div class="col-lg-12 col-md-12 col-sm-12 line-tabs pt-3 pb-2">
                                <ul class="nav nav-tabs nav-tabs-bottom">
                                    <li class="nav-item col-sm-3"><a class="nav-link active" data-bs-toggle="tab" href="{{url('#myprojects')}}">Projects</a></li>
                                    <li class="nav-item col-sm-3"><a class="nav-link" data-bs-toggle="tab" href="{{url('#tasks')}}">Tasks</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div id="tasks" class="tab-pane fade">
                                    <div class="project-task">
                                        <ul class="nav nav-tabs nav-tabs-top nav-justified mb-0">
                                            <li class="nav-item"><a class="nav-link active" href="{{url('#all_tasks')}}" data-bs-toggle="tab" aria-expanded="true">All Tasks</a></li>
                                            <li class="nav-item"><a class="nav-link" href="{{url('#pending_tasks')}}" data-bs-toggle="tab" aria-expanded="false">Pending Tasks</a></li>
                                            <li class="nav-item"><a class="nav-link" href="{{url('#completed_tasks')}}" data-bs-toggle="tab" aria-expanded="false">Completed Tasks</a></li>
                                        </ul>
...
@section('script')        
    ...
    <script src="{{ URL::asset('/assets/js/pages/task.init.js')}}"></script> 
