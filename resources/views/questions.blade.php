                                            ...
                                            <div style="display:none;" class="navbar">
                                                <div class="navbar-inner">
                                                    <ul class="nav nav-pills">
                                                        <li class="active"><a href="{{url('#step1')}}" data-bs-toggle="tab" data-step="1">Step 1</a></li>
                                                        <li class=""><a href="{{url('#step2')}}" data-bs-toggle="tab" data-step="2">Step 2</a></li>
                                                        <li class=""><a href="{{url('#step3')}}" data-bs-toggle="tab" data-step="3">Step 3</a></li>
                                                        <li class=""><a href="{{url('#step4')}}" data-bs-toggle="tab" data-step="4">Step 4</a></li>
                                                        <li class=""><a href="{{url('#step5')}}" data-bs-toggle="tab" data-step="5">Step 5</a></li>
                                                        <li class=""><a href="{{url('#step6')}}" data-bs-toggle="tab" data-step="6">Step 6</a></li>
                                                        <li class=""><a href="{{url('#step7')}}" data-bs-toggle="tab" data-step="7">Step 7</a></li>
                                                        <li class=""><a href="{{url('#step8')}}" data-bs-toggle="tab" data-step="8">Step 8</a></li>
                                                        <li class=""><a href="{{url('#step9')}}" data-bs-toggle="tab" data-step="9">Step 9</a></li>
                                                        <li class=""><a href="{{url('#step10')}}" data-bs-toggle="tab" data-step="10">Step 10</a></li>
                                                    </ul>
                                                </div>
                                            </div>
