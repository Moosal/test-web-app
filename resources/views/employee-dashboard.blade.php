...
@component('components.breadcrumb')                
    ...
    @slot('li_2') Employee Dashboard @endslot
@endcomponent 
                                ...
                                <div class="card-header">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link active" id="home-tab" data-bs-toggle="tab" href="{{url('#home')}}" role="tab" aria-controls="home" aria-selected="true">Today</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="{{url('#profile')}}" role="tab" aria-controls="profile" aria-selected="false">Tomorow</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="contact-tab" data-bs-toggle="tab" href="{{url('#contact')}}" role="tab" aria-controls="contact" aria-selected="false">Next 7 Days</a>
                                        </li>
                                    </ul>
