...
@component('components.breadcrumb')                
    @slot('title') Subscribed Companies @endslot
                                ...
                                <table class="table table-hover custom-table datatable mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="{{url('client-profile')}}" class="avatar"><img src="{{ URL::asset('/assets/img/profiles/avatar-14.jpg')}}" alt=""></a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="{{url('client-profile')}}" class="avatar"><img src="{{ URL::asset('/assets/img/profiles/avatar-18.jpg')}}" alt=""></a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="{{url('client-profile')}}" class="avatar"><img src="{{ URL::asset('/assets/img/profiles/avatar-28.jpg')}}" alt=""></a>
