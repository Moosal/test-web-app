                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="search-lists">
                                    <ul class="nav nav-tabs nav-tabs-solid pt-3 pb-2">
                                        <li class="nav-item"><a class="nav-link active" href="{{url('#results_projects')}}" data-bs-toggle="tab">Projects</a></li>
                                        <li class="nav-item"><a class="nav-link" href="{{url('#results_clients')}}" data-bs-toggle="tab">Clients</a></li>
                                        <li class="nav-item"><a class="nav-link" href="{{url('#results_users')}}" data-bs-toggle="tab">Users</a></li>
                                    </ul>
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="project-members m-b-15">
                                                                ...
                                                                <ul class="team-members">
                                                                    ...
                                                                    <li>
                                                                        <a href="#" data-bs-toggle="tooltip" title="Richard Miles"><img alt="" src="{{ URL::asset('/assets/img/profiles/avatar-09.jpg')}}"></a>
                                                                    </li>
                                                                    <li>
                                                                        <a href="#" data-bs-toggle="tooltip" title="John Smith"><img alt="" src="{{ URL::asset('/assets/img/profiles/avatar-10.jpg')}}"></a>
                                                                    </li>
                                                                    <li>
                                        ...
                                        <div class="tab-pane" id="results_clients">
                                            ...
                                            <div class="row staff-grid-row">
                                                <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                                                    <div class="profile-widget">
                                                        <div class="profile-img">
                                                            <a href="{{url('client-profile')}}" class="avatar"><img alt="" src="{{ URL::asset('/assets/img/profiles/avatar-19.jpg')}}"></a>
                                                        </div>
                                                        ...
                                                        <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{url('client-profile')}}">Global Technologies</a></h4>
                                                ...
                                                <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                                                    <div class="profile-widget">
                                                        <div class="profile-img">
                                                            <a href="{{url('client-profile')}}" class="avatar"><img alt="" src="{{ URL::asset('/assets/img/profiles/avatar-29.jpg')}}"></a>
                                                        </div>
                                                        <div class="dropdown profile-action">
                                                            <a href="#" class="action-icon dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{url('client-profile')}}">Delta Infotech</a></h4>
                                                        <h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{url('client-profile')}}">Tressa Wexler</a></h5>
                                                ...
                                                <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                                                    <div class="profile-widget">
                                                        <div class="profile-img">
                                                            <a href="{{url('client-profile')}}" class="avatar"><img src="{{ URL::asset('/assets/img/profiles/avatar-07.jpg')}}" alt=""></a>
                                                        </div>
                                                        <div class="dropdown profile-action">
                                                            <a href="#" class="action-icon dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{url('client-profile')}}">Ruby Bartlett</a></h5>
                                                        <div class="small text-muted">CEO</div>
                                                        <a href="{{url('chat')}}" class="btn btn-white btn-sm m-t-10">Message</a>
                                                        <a href="{{url('client-profile')}}" class="btn btn-white btn-sm m-t-10">View Profile</a>
                                                    </div>
                                                ...
                                                <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                                                    <div class="profile-widget">
                                                        <div class="profile-img">
                                                            <a href="{{url('client-profile')}}" class="avatar"><img src="{{ URL::asset('/assets/img/profiles/avatar-06.jpg')}}" alt=""></a>
                                                        </div>
                                                        <div class="dropdown profile-action">
                                                            <a href="#" class="action-icon dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{url('client-profile')}}">Wellware Company</a></h4>
                                                        <h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{url('client-profile')}}">Misty Tison</a></h5>
                                                        <div class="small text-muted">CEO</div>
                                                        <a href="{{url('chat')}}" class="btn btn-white btn-sm m-t-10">Message</a>
                                                        <a href="{{url('client-profile')}}" class="btn btn-white btn-sm m-t-10">View Profile</a>
                                                    </div>
                                                ...
                                                <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                                                    <div class="profile-widget">
                                                        <div class="profile-img">
                                                            <a href="{{url('client-profile')}}" class="avatar"><img alt="" src="{{ URL::asset('/assets/img/profiles/avatar-14.jpg')}}"></a>
                                                        </div>
                                                        <div class="dropdown profile-action">
                                                            <a href="#" class="action-icon dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{url('client-profile')}}">Mustang Technologies</a></h4>
                                                        <h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{url('client-profile')}}">Daniel Deacon</a></h5>
                                                        <div class="small text-muted">CEO</div>
                                                        <a href="{{url('chat')}}" class="btn btn-white btn-sm m-t-10">Message</a>
                                                        <a href="{{url('client-profile')}}" class="btn btn-white btn-sm m-t-10">View Profile</a>
                                                    </div>
                                                ...
                                                <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                                                    <div class="profile-widget">
                                                        <div class="profile-img">
                                                            <a href="{{url('client-profile')}}" class="avatar"><img alt="" src="{{ URL::asset('/assets/img/profiles/avatar-18.jpg')}}"></a>
                                                        </div>
                                                        <div class="dropdown profile-action">
                                                            <a href="#" class="action-icon dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{url('client-profile')}}">International Software Inc</a></h4>
                                                        <h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{url('client-profile')}}">Walter Weaver</a></h5>
                                                        <div class="small text-muted">CEO</div>
                                                        <a href="{{url('chat')}}" class="btn btn-white btn-sm m-t-10">Message</a>
                                                        <a href="{{url('client-profile')}}" class="btn btn-white btn-sm m-t-10">View Profile</a>
                                                    </div>
                                                ...
                                                <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                                                    <div class="profile-widget">
                                                        <div class="profile-img">
                                                            <a href="{{url('client-profile')}}" class="avatar"><img alt="" src="{{ URL::asset('/assets/img/profiles/avatar-28.jpg')}}"></a>
                                                        </div>
                                                        <div class="dropdown profile-action">
                                                            <a href="#" class="action-icon dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{url('client-profile')}}">Mercury Software Inc</a></h4>
                                                        <h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{url('client-profile')}}">Amanda Warren</a></h5>
                                                        <div class="small text-muted">CEO</div>
                                                        <a href="{{url('chat')}}" class="btn btn-white btn-sm m-t-10">Message</a>
                                                        <a href="{{url('client-profile')}}" class="btn btn-white btn-sm m-t-10">View Profile</a>
                                                    </div>
                                                ...
                                                <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                                                    <div class="profile-widget">
                                                        <div class="profile-img">
                                                            <a href="{{url('client-profile')}}" class="avatar"><img alt="" src="{{ URL::asset('/assets/img/profiles/avatar-13.jpg')}}"></a>
                                                        </div>
                                                        <div class="dropdown profile-action">
                                                            <a href="#" class="action-icon dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{url('client-profile')}}">Carlson Tech</a></h4>
                                                        <h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="{{url('client-profile')}}">Betty Carlson</a></h5>
                                                        <div class="small text-muted">CEO</div>
                                                        <a href="{{url('chat')}}" class="btn btn-white btn-sm m-t-10">Message</a>
                                                        <a href="{{url('client-profile')}}" class="btn btn-white btn-sm m-t-10">View Profile</a>
                                                    </div>
