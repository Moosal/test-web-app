...
@component('components.breadcrumb')                
    @slot('title') Performance Settings @endslot
    @slot('li_1') Settings @endslot
    @slot('li_2') Performance Settings @endslot
@endcomponent
@section('css')
    <!-- Select2 CSS -->
                                            ...
                                            <div class="col-md-12">
                                                <div class="card-box">
                                                    ...
                                                    <ul class="nav nav-tabs nav-tabs-bottom">
                                                        <li class="nav-item active"><a class="nav-link active" href="{{url('#okr_tab')}}" data-bs-toggle="tab">OKRs</a></li>
                                                        <li class="nav-item "><a class="nav-link" href="{{url('#compentency_tab')}}" data-bs-toggle="tab">Competency-based</a></li>
                                                        <li class="nav-item "><a class="nav-link" href="{{url('#smart_goals_tab')}}" data-bs-toggle="tab">SMART Goals</a></li>
                                                    </ul>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="text-center">
                                                                                        ...
                                                                                        <a href="{{url('https://newhrms.com/newhrms_stagging/settings/delete_performance_competency/6')}}" class="text-danger" title="" data-bs-toggle="ajaxModal" data-original-title="Delete"><i class="fa fa-times"></i></a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <th>
                                                                                    ...
                                                                                    <td class="text-center">
                                                                                        ...
                                                                                        <a href="{{url('https://newhrms.com/newhrms_stagging/settings/delete_performance_competency/7')}}" class="text-danger" title="" data-bs-toggle="ajaxModal" data-original-title="Delete"><i class="fa fa-times"></i></a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <th>
                                                                                    ...
                                                                                    <td class="text-center">
                                                                                        ...
                                                                                        <a href="{{url('https://newhrms.com/newhrms_stagging/settings/delete_performance_competency/8')}}" class="text-danger" title="" data-bs-toggle="ajaxModal" data-original-title="Delete"><i class="fa fa-times"></i></a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <th>
                                                                                    ...
                                                                                    <td class="text-center">
                                                                                        ...
                                                                                        <a href="{{url('https://newhrms.com/newhrms_stagging/settings/delete_performance_competency/9')}}" class="text-danger" title="" data-bs-toggle="ajaxModal" data-original-title="Delete"><i class="fa fa-times"></i></a>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
