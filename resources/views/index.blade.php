...
@section('css')
    <!-- Morris CSS -->
    <link rel="stylesheet" href="{{url('assets/libs/morris/morris.css')}}">
@endsection
										...
										<div class="row">
											<div class="col-md-12 mb-3">
												<div class="task-box color-one">
													<div class="task-media">
														<div class="task-icon">
															<img src="{{ URL::asset('/assets/img/icons/icon-01.png')}}" alt="Icons">
														</div>
														<div class="task-info">
															<h5>Pending Tasks</h5>
															<h2>55</h2>
											...
											<div class="col-md-12 mb-3">
												<div class="task-box color-two">
													<div class="task-media">
														<div class="task-icon">
															<img src="{{ URL::asset('/assets/img/icons/icon-02.png')}}" alt="Icons">
														</div>
														<div class="task-info">
											...
											<div class="col-md-12">
												<div class="task-box color-three">
													<div class="task-media">
														<div class="task-icon">
															<img src="{{ URL::asset('/assets/img/icons/icon-03.png')}}" alt="Icons">
														</div>
														<div class="task-info">
					...
					<div class="row">
						...
						<div class="col-md-6 d-flex">
							<div class="card card-table flex-fill">
								...
								<div class="card-footer">
									<a href="{{url('payments')}}">View all payments</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6 d-flex">
							<div class="card card-table flex-fill">
										...
										<table class="table custom-table mb-0">
											...
											<tbody>
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="#" class="avatar"><img alt="" src="{{ URL::asset('/assets/img/profiles/avatar-19.jpg')}}"></a>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="{{url('client-profile')}}" class="avatar"><img alt="" src="{{ URL::asset('/assets/img/profiles/avatar-07.jpg')}}"></a>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="{{url('client-profile')}}" class="avatar"><img alt="" src="{{ URL::asset('/assets/img/profiles/avatar-06.jpg')}}"></a>
								...
								<div class="card-footer">
									<a href="{{url('clients')}}">View all clients</a>
								</div>
							</div>
						</div>
						<div class="col-md-6 d-flex">
 ...
 @section('script')  
    ...
    <script src="{{ URL::asset('/assets/js/pages/chart.init.js')}}"></script>         
    <!-- Apexchart JS -->
